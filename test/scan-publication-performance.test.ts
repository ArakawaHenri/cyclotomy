...
function reportIndicator(
  ...
  console.info(`[cyclotomy:performance] ${JSON.stringify({
    scenario,
    ...Object.fromEntries(
...
describe("scan and publication performance indicators", () => {
  it("streams a 12 MiB file without embedding a base64 copy", async () => {
  ...
  it("reports first and repeated publication for 1,000 files", async () => {
